...
<?php
	...
	function sel2($conditions){
		$listInfo =listData(
			...
			"tbl_Awb",
			"WHERE  int_tipo = 1 AND int_Activo = 1 AND".$conditions,
			"ORDER BY int_ID");
		return $listInfo;
	}
...
var_to1,var_by1,var_to2,var_by2,var_termpagoOther,var_fechavuelo2,var_firstcarrie,var_toawb,var_shipperA,var_othCharg,var_prefawbm,int_tipo",
