...
function abre_add(int_ID){
	...
	varVentana = "add_tax.php?id="+int_ID;
...
function exe_add(int_ID){
	...
	actiontxt="http://www.easycargopro.com/ECP/view/age_tax/index.php?id="+int_ID;
...
function abre_upd(int_ID){
	...
	varVentana = "upd_tax.php?id="+int_ID;
	window.open(varVentana,"_self");
}

function exe_upd(int_ID,int_IDAgente){
...
function abre_del(int_ID,int_IDAgente)
{
	...
	if (confirmar){
		...
		varVentana = "http://www.easycargopro.com/ECP/view/age_tax/index.php?id="+int_ID;;
