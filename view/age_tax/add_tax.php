...
<body>
  ...
  <p align="center">Ultimos 10 registros.</p>
  <table id="listable" class="TablTax">
        ...
        <tbody>
            <?php foreach($listInfo=sel9("1=1 AND int_IDAgente=".$intID_Agente." AND var_Servicio = '$var_servi' AND var_Pais = '$var_Pais' ") as $listData): ?>
                ...
                <td>
                    ...
                    <input type="button" class="dell" value=" " onClick="exe_del(<?php echo $intID ?>,<?php echo $intID_Agente ?>,<?php  echo $listData["0"]?>)" />
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
	...
	<table width="40%" align="center">
            ...
            <tr>
                <td>Servicio</td>
                <td colspan="2">
                       <?php $serviciot=sel2("int_ID =".$var_servi.""); ?>
                        <input type="text" readonly name='txtCampo2' id='txtCampo2' value="<?php echo $var_servi?>" hidden>
                        <h2><?php echo  $serviciot[0][1] ?></h2>
                </td>
            </tr>
            <tr>
                <td>Pais</td>
                <td colspan="2">
                <input type="text" readonly name='txtCampo3' id='txtCampo3' value="<?php echo $var_Pais?>">
      ...
      <tr>
          ...
          <td colspan="2"><input name='txtCampo4' type='text'  id='txtCampo4' size='50' style="width:110px" placeholder="Empresa"required /> 
            ...
            <tr>
              <td>Es Opcional ? </td>
              <td><input type="checkbox" id="txtCampo9" name="txtCampo9"></td>
            </tr>
