	...
	<table width="40%">
        ...
        <?php foreach($listInfo=seluseer("int_ID=".$int_ID ) as $listData): ?>
            ...
            <tr>
                <td></td>
                <td colspan="">
                    <input name='id' type='text' id='id' size='50' hidden readonly value='<?php echo $listData[0]; ?>' />
            ...
            <tr>
                <td>Usuario</td>
                <td colspan="">
                    <input name='txtCampo1' type='text' class="ID" id='txtCampo1' size='50' readonly onchange="verif(this.value,'1');" required value='<?php echo $listData[1];?>' />
            ...
            <tr>
                <td>Contraseña</td>
                <td colspan="">
                    <input name='txtCampo2' type='password' id='txtCampo2' size='50' required onchange="valid();" value='<?php echo $listData[22];?>' />
                </td>
                <td colspan="2">
                    <input name='txtCampo23' type='password' id='txtCampo23' onchange="valid();" placeholder="Escriba de nuevo la Contraseña" size='50'   />
                </td>
            </tr>
            <tr>
