...
<?php
	...
	/*if(isset($_REQUEST['act'])){
		...
		$addInfo =insertData(
			"tbl_Empresa",
			"var_Empresa, var_Direccion, var_Ciudad, var_Estado, var_Pais, var_CodZip, var_Telefono,
			var_Fax, var_Email, txt_Terminos, int_Activo",
			"'$vrcTex1', '$vrcTex2', '$vrcTex3', '$vrcTex4', '$vrcTex5', '$vrcTex6', '$vrcTex7',
			 '$vrcTex8','$vrcTex9', '$vrcTex10', $vrcTex11, $vrcTex12, 1");
...
<?php
	...
	if(isset($_REQUEST['act'])){
		...
		$updInfo =updateData(
			"tbl_Empresa",
			"var_Empresa='$vrcTex1', var_Direccion='$vrcTex2', var_Ciudad='$vrcTex3', var_Estado='$vrcTex4',
				var_Pais='$vrcTex5', var_CodZip='$vrcTex6', var_Telefono='$vrcTex7', var_Fax='$vrcTex8',
				var_Email='$vrcTex9', txt_Terminos='$vrcTex10'",$vrcID);
