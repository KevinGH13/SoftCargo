...
function exe_add(){
	...
	actiontxt='http://www.kdigital.com.co/ECP/view/measure/';
	document.getElementById('formInsert').action = actiontxt;
}

function abre_upd(int_ID){
	
	varVentana = "upd_measure.php?id="+int_ID;
	window.open(varVentana,"_self");
}
...
function abre_del(int_ID)
{
	...
	if (confirmar){
		...
		varVentana = "http://www.kdigital.com.co/ECP/view/measure/";
