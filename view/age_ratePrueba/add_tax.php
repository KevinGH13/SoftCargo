  ...
  <table id="listable" class="TablTax">
        ...
        <tbody>
            <?php foreach($listInfo=sel9("1=1 AND int_IDAgente=".$intID_Agente." AND var_Servicio = '$var_servi' AND var_Pais = '$var_Pais' ") as $listData): ?>
                ...
                <td>
                    ...
                    <input type="button" class="dell" value=" " onClick="abre_del(<?php echo $intID ?>,<?php echo $intID_Agente ?>,<?php  echo $listData["0"]?>)" />
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
	...
	<table width="40%" align="center">
            ...
            <tr>
                <td>Servicio</td>
                <td colspan="2">
                <input type="text" readonly value="<?php  echo $var_servi?>">
            ...
            <tr>
                <td>Pais</td>
                <td colspan="2">
                <input type="text" readonly value="<?php echo $var_Pais?>">
