...
<body>
<script >cargar_An(true);</script>
<script> 
$( document ).ready(function() {
   document.getElementById('logs').innerHTML= "Cargando....";
});

window.onload = function () { 
    document.getElementById('logs').innerHTML= "Ciudades"; del_toast('showSuccessToast','Ciudades Cargadas ');	cargar_An(false);}

</script> 

<?php require('../menu.php'); ?>
    <h1> <div  class="icon-magic" id="logs">Cargando.... </div>  </h1>
