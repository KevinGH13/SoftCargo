...
<?php require('../menu.php'); ?>
          ...
          <?php foreach($listInfo=sel("int_IDConsolidado=".$intID_Con) as $listData): ?>
            ...
            <tr>
              ...
              <td > <?php foreach($listInfo=sel3("1=1 AND int_ID=".$listData[1]) as $listData1): if($listData1[2] == ""){echo "no hay datos";}else{echo $listData1[1];} endforeach?> </td>
               ...
               <td > <?php foreach($listInfo=sel3("1=1 AND int_ID=".$listData[3]) as $listData2): if($listData2[2] == ""){echo "no hay datos para mostrar";}else{echo $listData2[1];} endforeach?> </td>
            ...
            <tr>
              ...
              <td style="width:400px;" align="left" ><?php foreach($listInfo=sel3("1=1 AND int_ID=".$listData[1]) as $listData2): if($listData2[2] == ""){echo "no hay datos";}else{echo $listData2[2]." / ".$listData2[3];} endforeach?>  </td>
               <td></td>
               <td style="width:400px;" align="left" ><?php foreach($listInfo=sel3("1=1 AND int_ID=".$listData[3]) as $listData2): if($listData2[2] == ""){echo "no hay datos";}else{echo $listData2[2]." / ".$listData2[3];} endforeach?> </td>
            ...
            <tr>
                ...
                <td style="width:400px;" align="left" ><?php foreach($listInfo=sel3("1=1 AND int_ID=".$listData[1]) as $listData2): if($listData2[2] == ""){echo "no hay datos";}else{echo $listData2[4]." - ".$listData2[5];} endforeach?> </td>
                 <td></td>
               <td style="width:400px;" align="left" ><?php foreach($listInfo=sel3("1=1 AND int_ID=".$listData[3]) as $listData2): if($listData2[2] == ""){echo "no hay datos";}else{echo $listData2[4]." - ".$listData2[5];} endforeach?> </td>
    ...
    <th><input type="button" class="add" value=" insertar factura " onClick="abre_fact(<? echo $intID;?>,<? echo $intID_Con;?>)" />
        ...
        <input type="button" class="add" value="PDF" onClick="abre_add()" />
         <input type="button" class="add" value="Imprimir" onClick="abre_factCon(<? echo $intID_Con;?>)" />
    ...
    <table id="listable" class="display">
		...
		<tbody>
			<?php foreach($listInfo=sel8("int_NConsolidado=".$intID_Con) as $listData): ?>
            <tr>	
  ...
  <tr>
  <?php foreach($listInfo=sel10("int_NConsolidado=".$intID_Con) as $listData): ?>
