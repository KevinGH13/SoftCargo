<html>
<head>
	<title>Actualizar_Rutas</title>
	<?php require('../../librerias.php'); ?>
    <?php require('ctrl_rutas.php'); ?>
    <script language="javascript" src="validate_city.js"></script>
</head>
<body>
	...
	<table width="40%" align="center">
		...
		<?php foreach($listInfo=sel("int_ID=".$intID) as $listData): ?>
            ...
            <tr>
                <td>Rutas</td>
                <td colspan="2">
           			<input class="ID" name='txtCampo1' type='text' id='txtCampo1' size='50' readonly
                    value='<?php echo $listData[1]; ?>' />
                </td>
            </tr>
            <tr>
                <td>Direccion</td>
            ...
            <tr>
                <td>Estado</td>
                <td colspan="2">
                    <input class="ID" name='txtCampo4' type='text' id='txtCampo4' size='50' required readonly value='<?php echo $listData[4]; ?>' />
                </td>
            </tr>
            <tr>
                <td>Pais</td>
                <td colspan="2">
                    <input class="ID" name='txtCampo5' type='text' id='txtCampo5' size='50' required readonly value='<?php echo $listData[5]; ?>' />
                </td>
            </tr>
            <tr>
                <td>ZipCode</td>
                <td colspan="2">
                    <input name='txtCampo6' type='text' id='txtCampo6' size='50' value='<?php echo $listData[6]; ?>' />
                </td>
            </tr>
            <tr>
                <td>Telefono</td>
            ...
            <tr>
                <td>Terminos</td>
                <td colspan="2">
                    <textarea name='txtCampo10' id='txtCampo10' maxlength="700" placeholder="Máximo 700 caracteres" ><?php echo $listData[10]; ?></textarea>
                </td>
            </tr>
            <tr>
              <td colspan="3"></td>
