...
function exe_add(){
	...
	actiontxt='http://www.kdigital.com.co/ECP/view/sub_agents/';
...
function abre_upd(int_ID){
	...
	varVentana = "upd_subagent.php?id="+int_ID;
	window.open(varVentana,"_self");
}
...
function abre_del(int_ID)
{
	...
	if (confirmar){
		...
		varVentana = "http://www.kdigital.com.co/ECP/view/sub_agents/";
