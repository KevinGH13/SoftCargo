...
<?php require('../menu.php'); ?>
 <td>
              <select name='txtCampo' id='txtCampo'>
    ...
    <h1> <div class="icon-magic">Mis guias</div> </h1>
		...
		<tbody>
            ...
            <tr>	
                ...
                <td>
                    ...
                    <input type="button" class="Entrar" value="Borrar" onClick="abre_del(<?php echo $listData["0"]?>)" />
                </td>
            </tr>
			<?php endforeach; ?>
        </tbody>
