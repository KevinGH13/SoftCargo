...
function exe_add(){
	...
	actiontxt='http://sentcargo.easycargopro.com/ECP/view/services/';
	document.getElementById('formInsert').action = actiontxt;
}

function abre_upd(int_ID){
	
	varVentana = "upd_service.php?id="+int_ID;
	window.open(varVentana,"_self");
}
...
function abre_del(int_ID)
{
	...
	xmlhttp.onreadystatechange=function(){
		  if (xmlhttp.readyState==4 && xmlhttp.services==200){
	...
	if (confirmar){
		...
		varVentana = "http://sentcargo.easycargopro.com/ECP/view/services/";
