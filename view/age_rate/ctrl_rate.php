...
<?php
	...
	function sel8($conditions,$pais,$servicio){
		$listInfo8 = listData(
			"int_PesoDesde, int_PesoHasta, int_PesoInicial",
			"tbl_Tarifas",
			"WHERE int_Activo = '1' AND int_IDAgente = ".$conditions." AND var_Pais = '$pais' AND var_Servicio = '$servicio' ",
			"");
		return $listInfo8;
	}
?>
<?php
	...
	if(isset($_REQUEST['act'])){
		if($_REQUEST['act']=="verificar"){
				$pais = $_POST['pais'];
				$servicio = $_POST['s'];
				$agente = $_POST['agente'];

				$listInfo9 = listData(
				"int_PesoInicial,int_PesoDesde, int_PesoHasta",
				"tbl_Tarifas",
				"WHERE int_Activo = '1' AND int_IDAgente = $agente AND var_Pais = '$pais' AND var_Servicio = $servicio ",
				"");
		echo  json_encode($listInfo9);
			}} ?>
...
<?php
	...
	if(isset($_REQUEST['act'])){
		...
		echo "<script>window.open('index.php?id_Age=$vrcTex1','_self');</script>";
...
<?php
	...
	if(isset($_REQUEST['act'])){
		...
		echo "<script>window.open('index.php?id_Age='+$vrcAgente,'_self');</script>";
		}
	}
?>
<?php
