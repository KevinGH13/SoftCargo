...
<?php
	...
	function sel($conditions,$lim){
		...
		$listInfo =listData(
			"int_ID,var_Guia,var_NombreRemit,var_DireccionRemit,var_CiudadRemit,var_EstadoRemit,var_PaisRemit,int_CodZipRemit,var_TelefonoRemit,var_EmailRemit,
			...
			int_ValorDeclarado,int_ValorDeclaradoManual,int_ValorSeguro,int_ValorSeguroManual,int_CargosEmpresa,int_CargosAgente,int_Descuentos,int_TotalPagar,var_DescripcionContenido",
			"tbl_Guia",
	...
	function sel7($conditions){
		$listInfo7 = listData(
			...
			"tbl_Guia",
			" WHERE left(int_Guia,15) = $conditions and left(int_Guia,10) = substr($conditions, 0 , 10)",
			"");
		return $listInfo7;
	}
...
//calculos
//$vrcTextarifa = $_REQUEST['txtTarifa'];
//Agente
		...
		/*$addInfo =insertData(
			...
			var_NombreDest,var_DireccionDest,var_CiudadDest,var_EstadoDest,var_PaisDest,int_CodZipDest,var_TelefonoDest,var_EmailDest,
			var_TipoPago,decimal_PesoManual,decimal_DimAltoManual,decimal_DimAnchoManual,decimal_DimLargoManual,decimal_PesoCobrado,
			int_ValorDeclarado,int_ValorDeclaradoManual,int_ValorSeguro,int_ValorSeguroManual,int_CargosEmpresa,int_CargosAgente,int_Descuentos,int_TotalPagar,var_DescripcionContenido,int_Activo,var_Agente",
			//DATA
			...
			$vrcTexdeclarado,$vrcTex19,$vrcTexseguro,$vrcTex20,$vrcTex24,$vrcTex22,$vrcTex25,$vrcTextotal,'$vrcTex23',1,'$vrcTex0'"		
			);
...
if(isset($_REQUEST['act'])){
		...
		$listInfo4 = listData(
			"int_PesoInicial,int_PesoDesde,int_PesoHasta,int_LibraInicialAgente,int_LibraInicial,int_LibraAdicionalAgente,int_LibraAdicional,bol_Seguro,bol_Declarado,int_ValorFijoAgente,int_ValorFijoEmpresa",
			"tbl_Tarifas",
